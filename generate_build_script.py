  ...
  build:
    ...
    steps:
      ...
      - name: Push docker image
        run: docker push hanjf12/pytorch:${{IMAGE_TAG}}
"""
...
README_TEMPLATE = '| ![pytorch{}] ![python{}] ![{}] ![{}{}] [![](https://img.shields.io/docker/image-size/hanjf12/pytorch/{})][DockerHub] | `docker pull hanjf12/pytorch:{}` |'
